# MODULE_GUIDE – IA agentique institutionnelle

## 🎯 Objectif du module
La branche `feature/ai-agentic` a pour mission d’intégrer une IA générative dotée d’une couche agentique pour la décision autonome.  
Elle combine la connexion à des modèles existants (GPT, Claude, LLaMA/open-source) avec une trajectoire progressive vers la souveraineté institutionnelle.  
Ce module s’aligne sur la gouvernance ITCAA, les exigences de conformité **bancaire et comptable** (KYC, AML, IFRS, GAAP), et l’interopérabilité avec les autres modules FINSIG.
...
## 📌 Conclusion
La branche `feature/ai-agentic` transforme FINSIG en une infrastructure d’IA agentique gouvernée, sûre et progressive.  
Elle permet des preuves de valeur rapides avec fournisseurs existants, tout en préparant une souveraineté institutionnelle avec des backends offline et des modules spécialisés, dans le respect des **normes bancaires et comptables**.